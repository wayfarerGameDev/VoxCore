...
if sys.platform == 'linux':
    ...
    class TaskOutputKeysLinux:
        command = "--task_output_keys_linux"
        ...
        def boot(self):
            self.route_command("--ui_header Task booted: Output_Keys_Linux")
        ...
        def terminate(self):
            if self.ui:
                self.ui.close()
            self.route_command("--ui_header Task terminated: Output_Keys_Linux")
...
# Not supported
   ...
   class TaskCommandKeysLinux:
        ...
        def boot(self):
           self.route_command("--ui_error Task not supported on platofrm:  Output_Keys_Linux")
           pass
