...
if sys.platform == 'darwin':
    ...
    class TaskOutputKeysMac:
        command = "--task_output_keys_mac"
        ...
        def boot(self):
            self.route_command("--ui_header Task booted: Output_Keys_Mac")
        ...
        def terminate(self):
            self.route_command("--ui_header Task terminated: Output_Keys_Mac")
...
# Not supported
   ...
   class TaskOutputKeysMac:
        ...
        def boot(self):
           self.route_command("--ui_error Task not supported on device: Output_Keys_Mac")
           pass
